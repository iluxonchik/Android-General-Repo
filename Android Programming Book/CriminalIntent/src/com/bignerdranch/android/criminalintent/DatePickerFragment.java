		...
		.setPositiveButton(android.R.string.ok, 
				 new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						// When the button is clicked, create an intent, put the mDate in it
						// and send it back to the target fragment(CrimeFragment) via an intent
						// by calling the Fragment.onActivityResult()
